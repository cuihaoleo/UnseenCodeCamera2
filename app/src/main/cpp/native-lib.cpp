...
Java_com_example_unseencodecamera2_NativeLibWrapper_decodeJNI(
        JNIEnv *env,
        jobject /* this */,
        long addrInMat) {
...
Java_com_example_unseencodecamera2_NativeLibWrapper_detectBoxJNI(
        JNIEnv *env,
        jobject /* this */,
        long addrInMat) {
    cv::Mat *img = (cv::Mat*)addrInMat;
...
Java_com_example_unseencodecamera2_NativeLibWrapper_unseenCodeDecodeJNI(
        JNIEnv *env,
        jobject /* this */,
        jbyteArray input) {
